...
class HistoryPage(QWidget):
    ...
    def setup_ui(self):
        ...
        self.btn_hist.setIcon(create_colored_icon(icon_history, QColor(34, 197, 94), 28)) 
        ...
        self.btn_hist.setStyleSheet("color: #22C55E; border: none; font-size: 13px; font-weight: bold;")
