...
from PySide6.QtGui import QPixmap, QPainter, QColor, QBrush, QPainterPath, QIcon, QFont
...
class FieldCard(QFrame):
    def __init__(self, img_name, title, price, parent=None):
        super().__init__(parent)
        ...
        self.desc_lbl = QLabel("Buka setiap hari - Dari jam 08.00 - 22.00")
        self.desc_lbl.setObjectName("cardDesc")
        self.desc_lbl.setWordWrap(True)
        self.desc_lbl.setContentsMargins(0, 0, 0, 0)
        self.desc_lbl.setStyleSheet("color: #000000; font-weight: bold;")
        ...
        self.price_val = QLabel(f"{price}/Jam")
...
class HomePage(QWidget):
    ...
    def setup_ui(self):
        ...
        self.scroll_layout.addWidget(self.top_nav)
        ...
        content_layout.addWidget(FieldCard("lapangan_1.jpg", "Lapangan 1", "200.000"))
        content_layout.addWidget(FieldCard("lapangan_2.jpg", "Lapangan 2", "200.000"))
        content_layout.addWidget(FieldCard("lapangan_3.jpg", "Lapangan 3", "200.000"))
        ...
        # Tombol Booking (tidak aktif - abu-abu)
        ...
        # Tombol Riwayat (tidak aktif - abu-abu)
        ...
        # Tombol Pengaturan (tidak aktif - abu-abu)
